...
def main():
    ...
    try:
        ...
        print("=" * 70)
        print("PICK HEIGHT / ORIENTATION RECALIBRATION ONLY")
        print("=" * 70)
        print("This will NOT change:")
        print("- image_points.npy")
        print("- robot_points_xy.npy")
        print("- homography_matrix.npy")
        print("")
        print("It will update only:")
        print("- calibration/pick_reference.json")
        print("=" * 70)
        ...
        print("")
        print("=" * 70)
        print("PICK REFERENCE UPDATED")
        print("=" * 70)
        print(json.dumps(pick_reference, indent=4))
